...
public class CorsUtils {
    ...
    public static void handleCors(HttpServletRequest request, HttpServletResponse response) {
        /*
         ...
         */
        response.setHeader("Access-Control-Allow-Headers", "Content-Type, Access-Control-Allow-Headers, Authorization, X-Requested-With, token, app-ver");
